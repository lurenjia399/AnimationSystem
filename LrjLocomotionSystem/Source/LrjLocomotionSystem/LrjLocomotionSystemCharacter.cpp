...
#include "LrjLocomotionSystemCharacter.h"
...
ALrjLocomotionSystemCharacter::ALrjLocomotionSystemCharacter()
{
	...
	CharacterType = ECharacterType::CHARACTER_PLAYER_MAIN;
}

void ALrjLocomotionSystemCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void ALrjLocomotionSystemCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ALrjLocomotionSystemCharacter::Move);
...
void ALrjLocomotionSystemCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ALrjLocomotionSystemCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
